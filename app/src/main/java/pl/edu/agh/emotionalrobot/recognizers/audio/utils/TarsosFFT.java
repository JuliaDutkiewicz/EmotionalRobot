 ...
 * @author Joren Six
 */
public class TarsosFFT {

    /**
     * Forward FFT.
     */
    private final TarsosFloatFFT fft;
    private final WindowFunction windowFunction;
    private final int fftSize;
    private final float[] window;

    public TarsosFFT(final int size) {
        this(size,null);
    }
     ...
     * arning: the window is not applied in reverse when a backwards transform is requested.
     */
    public TarsosFFT(final int size, final WindowFunction windowFunction){
        fft = new TarsosFloatFFT(size);
        fftSize = size;
